...
<div class="panel-group m-b" id="accordion2">
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse in">
        <div class="wrapper">
              <div>
                <p><small class="text-uc text-xs text-muted">出金信息</small></p>
                <p>账号：{{$record->userName or '未知'}}</p>
                <p>出金方式：{{$record->wayZh or '未知'}}</p>
                <p>金额：{{$record->amount or '未知'}}</p>
                <div class="line"></div>
                <p><small class="text-uc text-xs text-muted">银行卡信息</small></p>
                <p>银行：{{$record->bankName or '未知'}}</p>
                <p>账户：{{$account->account_name or '未知'}},{{$account->account_number or '未知'}}</p>
  ...
  <div class="panel panel-default">
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree"><div class="panel-heading" style="background-color: #F5F5F5;"> 审核出金 </div></a>
