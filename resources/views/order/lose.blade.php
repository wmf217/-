    ...
    <tr>
      <td height="246" valign="top"><table width="1080" border="0" align="center" cellpadding="0" cellspacing="0" class="lutiao">
        <tr>
          ...
          <td width="490" align="left" valign="middle"><span class="lu">亏损产品</span><br />
            <span class="luying">Loss product</span></td>
        ...
        <table width="1080" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="508" height="343" align="center" valign="top"><table width="1080" border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="1080" height="41" border="0" align="center" cellpadding="0" cellspacing="0"  background="{{env('APP_URL')}}/images/kui.jpg">
                <tr>
                ...
                <td width="270" align="center" valign="middle" class="baitext"><strong>综合亏损</strong></td>
                </tr>
            </table>
            @foreach($obs as $ob)
              <table width="1080" border="0" align="center" cellpadding="0" cellspacing="1" class="biaogedilu" id="56" c="c">
                <tr>
                  ...
                  <td width="297" align="left" valign="middle" bgcolor="#f7f7f7" class="text12"><table width="84" border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="32" align="center" class="text12">${{$ob->win or '0.00'}}</td>
                    </tr>
                  </table>
                    <table width="105" bordercolor="#5cb85c" border="1" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="101" height="30" align="center" class="text12">{{$ob->wtime or '0'}} 笔{{$ob->whand or '0.00'}} 手 </td>
                      </tr>
                    </table></td>
                  <td width="305" align="center" valign="middle" bgcolor="#f7f7f7" class="text12"><table width="84" border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="32" align="center" class="text12">${{$ob->lose}}</td>
                    </tr>
                  </table>
                    <table width="105" bordercolor="#5cb85c" border="1" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="101" height="30" align="center" class="text12">{{$ob->ltime}} 笔{{$ob->lhand}} 手 </td>
                      </tr>
                    </table></td>
                  <td width="268" align="center" valign="middle" bgcolor="#f7f7f7" class="text12"><table width="84" border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="32" align="center" class="hong12">${{$ob->wl}} </td>
                    </tr>
                  </table>
                    <table width="105" bordercolor="#5cb85c" border="1" align="center" cellpadding="0" cellspacing="0">
                      <tr>
            ...
            <table width="1080" border="0" align="center" cellpadding="0" cellspacing="1" class="biaogedilu">
                <tr>
