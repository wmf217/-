    ...
    <tr>
      <td height="246" valign="top"><table width="1080" border="0" align="center" cellpadding="0" cellspacing="0" class="lantiao">
        <tr>
          ...
          <td width="490" align="left" valign="middle"><span class="lan14">历史交易</span><br />
            <span class="lanying">Historical transaction</span></td>
...
function refresh() {
    ...
    $('#table').DataTable($.extend(dataTableSetting(),{
        "sAjaxSource": "/order/api/api_history?name=" + login
